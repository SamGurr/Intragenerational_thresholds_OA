...
path<-"Data/TA/20190709" #the location of all your titration files
massfile<-"20190709mass_RUN2.csv" # name of your file with masses
titrationfile<-'20190709_RUN2.csv'# name of the last titration file run
