...
path<-"Data/TA/20190714" #the location of all your titration files
massfile<-"20190714mass_RUN4.csv" # name of your file with masses
titrationfile<-'20190714_RUN4.csv'# name of the last titration file run
