...
path<-"Data/TA/20190703" #the location of all your titration files
massfile<-"20190703mass_CRM.csv" # name of your file with masses
titrationfile<-'20190703_CRM.csv'# name of the last titration file run
