...
path<-"Data/TA/20190717" #the location of all your titration files
massfile<-"20190717mass_RUN2.csv" # name of your file with masses
titrationfile<-'20190717_RUN2.csv'# name of the last titration file run
